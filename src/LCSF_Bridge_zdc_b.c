...
static void LCSF_Bridge_zdcset_entity_stateGetData(lcsf_valid_att_t *pAttArray, zdc_cmd_payload_t *pCmdPayload);
static void LCSF_Bridge_zdcset_entity_keyexprGetData(lcsf_valid_att_t *pAttArray, zdc_cmd_payload_t *pCmdPayload);
...
static void LCSF_Bridge_zdcset_entity_stateGetData(lcsf_valid_att_t *pAttArray, zdc_cmd_payload_t *pCmdPayload) {
    ...
    // Retrieve data of attribute entity_id
    memcpy(&(pCmdPayload->set_entity_state_payload.entity_id), pAttArray[ZDC_SET_ENTITY_STATE_ATT_ENTITY_ID].Payload.pData, pAttArray[ZDC_SET_ENTITY_STATE_ATT_ENTITY_ID].PayloadSize);
    // Retrieve data of attribute state
    memcpy(&(pCmdPayload->set_entity_state_payload.state), pAttArray[ZDC_SET_ENTITY_STATE_ATT_STATE].Payload.pData, pAttArray[ZDC_SET_ENTITY_STATE_ATT_STATE].PayloadSize);
}
...
static void LCSF_Bridge_zdcset_entity_keyexprGetData(lcsf_valid_att_t *pAttArray, zdc_cmd_payload_t *pCmdPayload) {
    ...
    // Retrieve data of attribute entity_id
    memcpy(&(pCmdPayload->set_entity_keyexpr_payload.entity_id), pAttArray[ZDC_SET_ENTITY_KEYEXPR_ATT_ENTITY_ID].Payload.pData, pAttArray[ZDC_SET_ENTITY_KEYEXPR_ATT_ENTITY_ID].PayloadSize);
    // Retrieve data of attribute keyexpr
    pCmdPayload->set_entity_keyexpr_payload.p_keyexpr = pAttArray[ZDC_SET_ENTITY_KEYEXPR_ATT_KEYEXPR].Payload.pData;
}
...
static void LCSF_Bridge_zdcset_entity_configGetData(lcsf_valid_att_t *pAttArray, zdc_cmd_payload_t *pCmdPayload) {
    ...
    // Retrieve data of attribute entity_id
    memcpy(&(pCmdPayload->set_entity_config_payload.entity_id), pAttArray[ZDC_SET_ENTITY_CONFIG_ATT_ENTITY_ID].Payload.pData, pAttArray[ZDC_SET_ENTITY_CONFIG_ATT_ENTITY_ID].PayloadSize);
    // Retrieve data of attribute entitiy_config
    pCmdPayload->set_entity_config_payload.p_entitiy_config = pAttArray[ZDC_SET_ENTITY_CONFIG_ATT_ENTITIY_CONFIG].Payload.pData;
}
...
static void LCSF_Bridge_zdcGetCmdData(uint_fast16_t cmdName, lcsf_valid_att_t *pAttArray, zdc_cmd_payload_t *pCmdPayload) {
    ...
    switch (cmdName) {
        case ZDC_CMD_SET_ENTITY_STATE:
            LCSF_Bridge_zdcset_entity_stateGetData(pAttArray, pCmdPayload);
            break;

        case ZDC_CMD_SET_ENTITY_KEYEXPR:
            LCSF_Bridge_zdcset_entity_keyexprGetData(pAttArray, pCmdPayload);
            break;

        case ZDC_CMD_SET_ENTITY_CONFIG:
            LCSF_Bridge_zdcset_entity_configGetData(pAttArray, pCmdPayload);
            break;
...
static bool LCSF_Bridge_zdclist_entities_respFillAtt(lcsf_valid_att_t **pAttArrayAddr, zdc_cmd_payload_t *pCmdPayload) {
    ...
    if (!FiloGet(&LcsfBridgezdcInfo.Filo, LCSF_ZDC_CMD_LIST_ENTITIES_RESP_ATT_NB, (void *)pAttArrayAddr)) {
        return false;
    }
...
bool LCSF_Bridge_zdcInit(void) {
    return FiloInit(&LcsfBridgezdcInfo.Filo, LcsfBridgezdcInfo.FiloData, LCSF_BRIDGE_ZDC_FILO_SIZE, sizeof(lcsf_valid_att_t));
}
